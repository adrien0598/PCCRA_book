...
ggplot(cpt) +
  ...
  labs(title = "Réponses à la Campthotecine par stress", x = "Perte de fitness (log)", y = "Densité", subtitle = "Parmis les 448 stress distincts")+
...
En selectionnant les mutant dont la medianne de fitness defect est la plus basse, on obtient le même enrichissement :
